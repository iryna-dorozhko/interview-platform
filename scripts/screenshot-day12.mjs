...
async function main() {
  ...
  // 1) Deep prep: chat showing work-conditions block
  {
          ...
          messages: [
            {
              ...
              content: 'Дякую, Ірино. Тепер про умови роботи: який формат тобі підходить — офіс, гібрид чи remote?',
            ...
            },
            {
              id: 'm3',
              authorType: 'AGENT_CANDIDATE',
              content: 'Зрозуміло. Які зарплатні очікування — діапазон або мінімум, і в якій валюті?',
            ...
            },
            {
              id: 'm5',
              authorType: 'AGENT_CANDIDATE',
              content: 'Дякую. Який графік тобі зручний — повний день, part-time чи гнучкий?',
              createdAt: new Date().toISOString()
            }
          ],
          isClosed: false,
    ...
    await uiLogin(page, MAIN_UI, '/candidate/login', CANDIDATE_EMAIL, CANDIDATE_PASSWORD, '**/candidate**')
  ...
  // 3) Candidate matches — offer card (worktree UI)
  {
    ...
    await uiLogin(page, MATCH_UI, '/candidate/login', CANDIDATE_EMAIL, CANDIDATE_PASSWORD, '**/candidate**')
