...
const STYLES: Record<LiveAuthorType, { label: string; accent: BubbleStyle; labelStyle: LabelStyle }> = {
  HUMAN_HR: {
    label: 'HR',
...
const CONFIDENCE_BADGES: Record<CandidateConfidence, { label: string; background: string; color: string }> = {
