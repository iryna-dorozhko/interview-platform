...
async function openDecision(type: InterviewDecisionType): Promise<void> {
  ...
  try {
    ...
    modalError.value = error instanceof Error ? error.message : 'Не вдалося згенерувати лист'
  }
}
...
async function submitDecision(): Promise<void> {
  ...
  try {
    ...
    modalState.value = 'edit'
    modalError.value = error instanceof Error ? error.message : 'Не вдалося надіслати'
  }
}
...
async function loadReport(): Promise<void> {
  ...
  try {
    ...
    errorMessage.value = error instanceof Error ? error.message : 'Не вдалося завантажити звіт'
  }
}
...
<template>
  <main class="report-page">
    ...
    <template v-else-if="report">
      ...
      <section v-if="report.overrideKind && report.overrideReason" class="exception-block">
