...
// Будує CompanyProfileAgentMessages.
...
export function parseHrCompanyProfileExtraction(rawText: string): HrCompanyProfileExtracted {
  ...
  const { companyName, culture, companyDirection, policies, workFormat, onboardingApproach } = data as Record<
    string,
    unknown
  >
...
// Будує HrCompanyProfileExtractionMessages.
