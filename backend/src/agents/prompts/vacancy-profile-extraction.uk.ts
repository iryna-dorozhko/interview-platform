...
{"role": "назва посади", "requirements": ["вимога 1", "вимога 2"], "expectations": ["очікування 1"]}

Правила:
- "role" — короткий рядок з назвою посади (наприклад, "Middle Backend Developer").
- "requirements", "expectations" — масиви коротких рядків українською; кожен пункт — одна конкретна деталь із діалогу.
