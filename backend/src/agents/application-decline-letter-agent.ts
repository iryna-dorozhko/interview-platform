...
// Будує ApplicationDeclineLetterMessages.
export function buildApplicationDeclineLetterMessages(ctx: ApplicationDeclineLetterContext): ChatMessage[] {
  const userContent = [
    `=== ВАКАНСІЯ ===`,
    ctx.vacancyTitle,
    '',
...
// Модуль generateApplicationDeclineLetter.
