...
import { SEED_HR_USER, hashPassword, seedHrUser } from './hr-user.js'
...
test('seedHrUser upserts HR user with hashed password', async () => {
  ...
  assert.equal(upsertArgs.create.passwordHash, '8d969eef6ecad3c29a3a629280e686cf0c3f5d5a86aff3ca12020c923adc6c92')
