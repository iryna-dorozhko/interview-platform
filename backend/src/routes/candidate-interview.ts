...
// Модуль interviewPayload.
function interviewPayload(interview: { id: string; displayName: string; status: string; kind?: string }) {
  return {
    id: interview.id,
...
// Створює CandidateInterviewRouter.
